...
# See the License for the specific language governing prateermissions and
...
def create_model_info(architecture):
  ...
  if architecture == 'inception_v3':
    ...
    data_url = 'http://download.tensorflow.org/models/image/imagenet/efficientnetv1_b2.tgz'
    bottleneck_tensor_name = 'pool_3/_reshape:0'
    bottleneck_tensor_size = 1408
    input_width = 128
    input_height = 80
    input_depth = 3
    resized_input_tensor_name = 'Mul:0'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='./classify_data/traincnn/',
